...
class Ball(pygame.sprite.Sprite):
    ...
    def __init__(self, gravity=False, color=None, size=20):
        ...
        self.bounce_wall = pygame.mixer.Sound('assets/bounce_wall.mp3')
    ...
    #added the power_shot parameter
    def bounce(self, direction=None, power=True, power_shot=False):
        """Bounce the ball"""
        ...
        # Power shot bounce: more speeder ball wooooooo
        if power_shot:
            self.hspeed *= 2.0